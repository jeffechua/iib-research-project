...
def zOrder(x, y, minX, minY, size):
    ...
    x = int(32767 * (x - minX) // size) # jec226: added the int() because bitshifting floats
    y = int(32767 * (y - minY) // size) # was sometimes causing errors (not sure why? may be 0.0 throwing it)
